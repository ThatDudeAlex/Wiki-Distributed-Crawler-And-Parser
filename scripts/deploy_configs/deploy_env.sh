...
docker compose -f docker/docker-compose.yml -f docker/environments/docker-compose.$DEPLOY_ENV.yml build --no-cache scheduler
...
docker compose -f docker/docker-compose.yml -f docker/environments/docker-compose.$DEPLOY_ENV.yml build --no-cache parser
...
docker compose -f docker/docker-compose.yml -f docker/environments/docker-compose.$DEPLOY_ENV.yml build --no-cache \
  crawler_noproxy \
...
docker compose -f docker/docker-compose.yml -f docker/environments/docker-compose.$DEPLOY_ENV.yml build --no-cache dispatcher
